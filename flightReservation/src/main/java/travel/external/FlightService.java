...
@FeignClient(name = "screen", url = "${api.url.screen}")// 나중에 리펙토링 제대로 되면 screen 이아니라 flight 로 사용 yml에도 screen->flight 변경
public interface FlightService {
    ...
    @GetMapping(path = "/flights/search")       // 좌석 호출 하기 위해 찾음
